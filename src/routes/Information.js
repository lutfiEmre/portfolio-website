    ...
    return(
        <motion.div variants={item} className="card flex w-full h-full justify-center items-center">
            <motion.div className={' md:w-[555px] w-[300px] sm:w-[450px] sm:h-[450px] md:h-[390px] mt-5 rounded-[15px] ml-2 bg-light-bg3 dark:bg-dark-bg3 border-[2.05px] border-dashed border-border1 pl-[20px] pr-[5px] pb-[25px]'}>
                <h2 aria-label={'EmreLutfi Information'} className={'font-text5 pt-6 pb-4  text-2xl text-light-text2 dark:text-dark-text1'}>Information</h2>
                <h3 aria-label={'EmreLutfi About Him'} className={'font-text6 text-light-text3 dark:text-dark-text2 sm:w-[420] md:w-[530px] text-m'}>
                    ...
                    <span aria-label={'EmreLutfi Technical Support, Linkedin'} className={'font-bold text-outtext5 dark:text-dark-outtext5'}> Front-End Developer and UI UX Designer</span>
                    <span aria-label={'EmreLutfi Datafex, Datafex'} className={'font-extrabold text-outtext6 dark:text-dark-outtext6'}> at User Metrics</span>
                </h3>
            </motion.div>
        </motion.div>
